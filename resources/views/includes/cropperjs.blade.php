<link rel="stylesheet" type="text/css" href="{{url('bower_components/cropperjs/dist/cropper.css')}}">
<script src="{{url('bower_components/cropperjs/dist/cropper.min.js')}}"></script>
